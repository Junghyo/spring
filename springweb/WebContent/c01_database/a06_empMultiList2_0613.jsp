...
<body>
	...
	<form method="post">
		...
		직책	 <input type="checkbox" name="jobs" value="MANAGER"/>MANAGER
			 <input type="checkbox" name="jobs" value="CLERK"/>CLERK
			 <input type="checkbox" name="jobs" value="SALESMAN"/>SALESMAN
			 <input type="checkbox" name="jobs" value="PRESIDENT"/>PRESIDENT
			 <input type="checkbox" name="jobs" value="ANALYST"/>ANALYST
			 <input type="checkbox" name="jobs" value="타자"/>타자
			 <input type="checkbox" name="jobs" value="가수"/>가수
			 <input type="checkbox" name="jobs" value="SUPERMAN"/>SUPERMAN<br>
